...
title: "View released jobs for a production schedule"
draft: false
type: Article

---

You can view and print a list of released jobs for a production schedule. You can generate dispatch reports based on a What-If schedule without first committing the schedule.

> [!Note] The **Job Order Dispatch List** window is only available when Advanced Scheduling is active.

**To view released jobs for a production schedule**
...
6. Define the job order scope, if required.
    ...
    a. Click the **Job Order Scope** tab.
...
10. On the **Toolbar** of **Job Order Dispatch List** page, click one of the output options to generate the report.
