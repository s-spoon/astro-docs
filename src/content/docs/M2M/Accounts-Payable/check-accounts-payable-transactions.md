...
1.  Open the **AP Detail Listing (RPAPTL)** page.
    ...
    - Select **Financial Management** > **Financial Reports** > **Accounts Payable** > **AP Detail Listing**.

    Or

    - Search for **RPAPTL** in the **Navigation box** and then select **AP Detail Listing**. The **AP Detail Listing** page appears.
