...
1. Open the **Sales Tax (Report) (RPSLTX)** page.
    ...
    a. Select **Financial Management** > **Financial Reports** > **Accounts Receivable** > **Sales Tax (Report)**.

    Or

    b. Search for **RPSLTX** in the **Navigation box** and then select **Sales Tax (Report)**
