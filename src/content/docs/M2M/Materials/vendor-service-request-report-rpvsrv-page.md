...
title: "Vendor Service Request Report (RPVSRV) page"
draft: false
type: Article
...
1. Open the Vendor Service Request Report (RPVSRV) page.
    ...
    - Select **Production Management** > **Production Reports** > **Quality** > **Vendor Service Request Report**.

    Or

    - Search for **RPVSRV** or **Vendor Service Request Report** in the **Navigation box** and then select **Vendor Service Request Report**.

        THe **Vendor Service Request Report (RPVSRV)**  page appears.
...
7. In the **Other Variables** section, type a value in the **Part Revision**, **Facility** or other fields.
