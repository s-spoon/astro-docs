...
title: "Inventory Movement [RPIMOV]"
draft: false
type: Article

---

Use the **Inventory Movement**page that shows inventory transactions for any or all parts. You can print the report or view it on the screen.

By default, generic filters are available to generate this report. You can use **Advanced Filters** to customize or expand your filter criteria. 


**To generate an Inventory Movement Report**

1. Open the Inventory Movement (RPIMOV) page.

    - Select **Production Management** > **Production Reports** > **Inventory** > **Inventory Movement**.

    Or

    - Search for **RPIMOV** in the **Navigation box** and then select **Inventory Movement**.

   The **Inventory Movement (RPIMOV)** page appears.
...
7. In the **Other Variables** area, type values for **Facility** and **Revision** fields.
