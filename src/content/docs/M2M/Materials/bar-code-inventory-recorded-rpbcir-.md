...
title: "Bar Code Inventory Recorded [RPBCIR]"
draft: false
type: Article

---

Use the **Bar Code Inventory Recorded** page report of the inventory information you collect using the bar code system.

By default, generic filters are available to generate this report. You can use **Advanced Filters** to customize or expand your filter criteria. 


**To generate a Bar Code Inventory Recorded Report**

1. Open the Bar Code Inventory Recorded (RPBCIR) page.

    - Select **Production Management** > **Production Reports** > **Bar Code** > **Bar Code Inventory Recorded**.

    Or

    - Search for **RPBCIR** in the **Navigation box** and then select **Bar Code Inventory Recorded**.

        The **Bar Code Inventory Recorded (RPBCIR)** page appears.
