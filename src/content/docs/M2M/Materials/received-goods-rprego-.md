...
1. Open the **Received Goods** (RPREGO) page.
    ...
    - Select **Production Management** > **Production Reports** > **Shipping & Receiving** > **Received Goods**.

    Or

    - Search for **RPREGO** in the **Navigation box** and then select **Received Goods**.

   The **Received Goods (RPREGO)**  page appears.
