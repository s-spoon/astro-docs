---
title: "Cost Roll-Up Report [RPCRUP]"
draft: false
type: Article
---

Use the **Cost Roll-Up Report** page to view the list of inventory items and costs that were changed during cost roll-up.
...
## To generate a Cost Roll Up Report

1. Open the **Cost Roll Up Report (RPCRUP)** page.

   1. Select **Financial Management** > **Financial Reports** > **Order Costing** > **Cost Roll Up Report**.

        Or

   2. Search for **RPCRUP** in the **Navigation box** and then select **Cost Roll Up Report**.

       The **Cost Roll Up Report (RPCRUP)** page appears.
...
7. In the **Other Variables** Area, type values for **Revision (OPTIONAL)** and **Facility** fields.
